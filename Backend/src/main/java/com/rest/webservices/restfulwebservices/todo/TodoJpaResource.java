...
public class TodoJpaResource {
	...
	// Self-coded service methods are commented out
	// todoRespository are methods built in to JPARepository
	...
	public Todo updateTodo(@PathVariable String username,  @RequestBody Todo todo) {
		...
		todo.setId(null); // since id is null, new todo is created with save method instead of an update
